...
const VenueCardOverlay = ({
  ...
  return (
    <div
      {...props}
      className={`card border-0 pt-5${className ? ` ${className}` : ''}`}
    >
        ...
        <div className="d-md-flex justify-content-between align-items-end">
          ...
          {button && (
            <div className="btn-group">
              {button.href ? (
                <Link href={button.href}>
                  <a
                    ...
                    className={
                      button.variant
                        ? `btn btn-${button.variant} rounded-end-0 px-3`
                        : 'btn btn-primary rounded-end-0 px-3'
                    }
                  >
                    {button.title}
                  </a>
              ...
              <div
                className="posiion-relative border-start border-light zindex-5"
              ...
              <button
                ...
                className={
                  button.variant
                    ? `btn btn-${button.variant} rounded-start-0 px-3`
                    : 'btn btn-primary rounded-start-0 px-3'
                }
              >
