...
const HomePage = () => {
  ...
  return (
    <CityGuidePageLayout pageTitle="Welcome" activeNav="Home">
      {/* Hero */}
        ...
        <Row className="align-items-center mt-md-2">
          <Col lg={7} className="order-lg-2 mb-lg-0 mb-4 pb-2 pb-lg-0">
            <div className="d-flex justify-content-center">
              <ImageLoader
                src="/images/city-guide/home/hero-img.jpg"
                width={1492}
                height={972}
                alt="Hero image"
              />
          ...
          <Col lg={5} className="order-lg-1 pe-lg-0">
            ...
            <p className="text-lg-start text-center mb-4 mb-lg-5 fs-lg">
              Inspire from our curated virtual famtrips or find great places and
              activities in the travel catalog.
            </p>
      ...
      <Container as="section" className="mb-5 pb-3">
        <div className="d-md-flex align-items-center justify-content-between position-relative zindex-5 mb-2 pb-md-2">
          <h2 className="h3 w-100 mb-4 mb-md-3 me-md-3">Latest Famtrips</h2>

          <Link href="/famtrips" passHref>
          ...
          >
            <SwiperSlide>
              <VenueCardOverlay
                ...
                title="Discover the originals - Malmö & Helsingborg in Skåne"
                tag="ROUND TRIP"
                button={{
                  href: '#',
                  title: 'Explore',
      ...
      <Container as="section" className="mb-sm-5 mb-4 pb-lg-4">
              ...
              <SwiperSlide key={indx}>
                <VenueCard
                  ...
                  wishlistButton={{
                    ...
                    props: {
                      onClick: () =>
                        console.log('Venue added to your Wishlist!'),
                    },
                  }}
                />
              </SwiperSlide>
        ...
        <div
          id="pagination"
          className="swiper-pagination position-relative bottom-0 d-xxl-none pt-2 mt-4 pb-4 pb-sm-3"
        ></div>
      </Container>
      ...
      <Container as="section" className="mb-5 pb-lg-4">
        <Row>
          ...
          <Col lg={4} className="text-center text-lg-start mb-lg-0 mb-5">
            <a
              href="#"
              className="d-block text-decoration-none bg-faded-accent rounded-3 h-100"
            >
              <div className="p-4">
            ...
            <Row>
              ...
              <Col md={5} className="bg-light">
                ...
                <p className="pb-2 delay-3 from-end d-none d-lg-block">
                  ...
                  ut quis ac. Amet, cras orci justo, tortor nisl aliquet. Enim
                  tincidunt tellus nunc, nulla arcu posuere quis. Velit turpis
                  orci venenatis risus felis, volutpat convallis varius. Enim
                  non euismod adipiscing a enim.
                </p>
          ...
          <SwiperSlide>
            <Row>
              ...
              <Col md={5} className="bg-light">
                ...
                <p className="pb-2 delay-3 from-end d-none d-lg-block">
                  Sem nibh urna id arcu. Quis tortor vestibulum morbi volutpat.
                  Et duis et sed tellus. Egestas ultrices viverra in pretium
                  nec. Dui ornare fusce vel fringilla scelerisque posuere
                  pharetra ut. Dui donec sapien, dictum nunc varius.
                </p>
                <Link href="/city-guide/single" passHref>
                  <Button variant="primary rounded-pill delay-4 scale-up">
                    View more
